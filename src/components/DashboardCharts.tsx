  ...
  return (
    <Card className="p-8 rounded-[3rem] border-2 border-zinc-50 shadow-xl shadow-zinc-200/30">
      <div className="flex items-center justify-between mb-10">
        <div>
          <h3 className="text-xl font-black text-zinc-900 tracking-tight">Perbandingan Kas Mingguan</h3>
          <p className="text-xs font-bold text-zinc-400 mt-1 uppercase tracking-widest">Omzet vs Pengeluaran (7 Hari Terakhir)</p>
        </div>
      </div>
