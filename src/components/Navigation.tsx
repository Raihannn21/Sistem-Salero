                ...
                {visibleItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      href={item.href}
                      className={cn(
                        "flex items-center gap-4 px-6 py-4 rounded-2xl transition-all duration-300 font-bold text-sm whitespace-nowrap",
                        isActive
              ...
              <div className="space-y-3">
                {visibleItems.map((item) => (
                  <Link
                    ...
                    onClick={() => setIsOpen(false)}
                    className={cn(
                      "flex items-center gap-4 px-6 py-4 rounded-2xl font-bold transition-all text-sm uppercase tracking-wider whitespace-nowrap",
                      pathname === item.href
                        ? "bg-primary text-white shadow-xl shadow-primary/20"
                        : "text-zinc-500 hover:bg-zinc-900 hover:text-zinc-100"
                    )}
                  >
                    <item.icon size={20} className={cn("shrink-0", pathname === item.href ? "text-white" : "text-zinc-700")} />
                    {item.label}
                  </Link>
                ))}
              </div>
